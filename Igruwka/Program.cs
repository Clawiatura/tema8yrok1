...
if (userHero == "Воин")
{
    if (numberUsser == 'r')
    {
        ...
        {
            Console.WriteLine("Воин победил разбойника!");
        }
    }
}
if (userHero == "Охотник")
{
    if (numberUsser == 'r')
    {
        ...
        {
            Console.WriteLine("Охотник победил разбойника!"); 
        }
    }
}
if (userHero == "Маг")
{
    if (numberUsser == 'r')
    {
        ...
        {
            Console.WriteLine("Ваш маг победил разбойника!"); 
        }
    }
}
// Хотел сделать чтобы надо было выиграть несколько раз, но запутался с тем как сделать, чтобы цикл повторялся. Так же хотел добавить всякие уровни сложностей и т.д, но не смог :(